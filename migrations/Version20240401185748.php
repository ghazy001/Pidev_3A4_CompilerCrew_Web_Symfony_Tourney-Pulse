 ...
 */
final class Version20240401185748 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE images_stade (id INT AUTO_INCREMENT NOT NULL, id_stade INT NOT NULL, url_image VARCHAR(2555) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, id_organisateur INT DEFAULT NULL, id_stade INT NOT NULL, date DATE NOT NULL, id_DeuxiemeEquipe INT DEFAULT NULL, id_PremiereEquipe INT DEFAULT NULL, INDEX fk_equipe1 (id_PremiereEquipe), INDEX fk_equipe2 (id_DeuxiemeEquipe), INDEX fk_user (id_organisateur), INDEX FK_stade_Reservation (id_stade), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
